  ...
  "../../node_modules/luxon/build/node/luxon.js"(exports) {
    ...
    var Duration = class _Duration {
      ...
      set(values2) {
        ...
        const mixed = {
          ...this.values,
          ...normalizeObject(values2, _Duration.normalizeUnit)
        };
        return clone$1(this, {
          values: mixed
        });
      ...
      for (var i = 0, l = ranges.length; i < l; ++i) {
        ...
        if (range.step * multiplier > range.end) {
          result = result.concat(
            Array.from({ length: range.end - range.start + 1 }).map(function(_2, index) {
...
var require_fp = __commonJS({
  "../../node_modules/lodash/fp.js"(exports, module2) {
    "use strict";
    var _2 = require_lodash_min().runInContext();
    module2.exports = require_baseConvert()(_2, _2);
  }
});
...
var RoleColor = /* @__PURE__ */ ((RoleColor2) => {
  RoleColor2["ADMIN"] = "var(--spectrum-global-color-static-red-400)";
  RoleColor2["POWER"] = "var(--spectrum-global-color-static-orange-400)";
  RoleColor2["BASIC"] = "var(--spectrum-global-color-static-green-400)";
  RoleColor2["PUBLIC"] = "var(--spectrum-global-color-static-blue-400)";
  RoleColor2["BUILDER"] = "var(--spectrum-global-color-static-magenta-600)";
  RoleColor2["DEFAULT_CUSTOM"] = "var(--spectrum-global-color-static-magenta-400)";
  return RoleColor2;
})(RoleColor || {});
...
var ValidSnippetNameRegex = /^[a-z_][a-z0-9_]*$/i;
...
__export(cron_exports, {
  getNextExecutionDates: () => getNextExecutionDates,
  validate: () => validate
});
...
function getNextExecutionDates(cronExpression, limit2 = 4) {
  const parsed = import_cron_parser.default.parseExpression(cronExpression);
  const nextRuns = [];
