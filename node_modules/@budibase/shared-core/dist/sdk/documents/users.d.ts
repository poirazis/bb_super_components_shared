...
export declare function canCreateApps(user: User | ContextUser): boolean;
...
export declare function isAdminOrGlobalBuilder(user: User | ContextUser): boolean;
export declare function hasAppBuilderPermissions(user?: User | ContextUser): boolean;
export declare function hasAppCreatorPermissions(user?: User | ContextUser): boolean;
...
export declare function hasCreatorPermissions(user?: User | ContextUser): boolean;
export declare function isCreator(user?: User | ContextUser): boolean;
